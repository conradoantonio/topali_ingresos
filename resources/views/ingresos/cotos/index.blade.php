...
<div class="text-center" style="margin: 20px;">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xs-12">
                            ...
                            {{-- <div class="div_subcoto">
                                <p class="form-control-static bold">Subcoto: <span class="normal" id="subcoto"></span></p>
                            </div> --}}
	...
	<div class="row normal-margin">
		<h2 class="title-guardia">Lista de ingresos</h2><br>
		<br><h4 class="text-left">Estacionamientos disponibles: {{$num_lugares}}</h4>
		<h4 class="text-left">Lugares ocupados: {{$ocupados}}</h4>
		<a href="{{url()}}/ingresos/cotos/formulario"><button type="button" class="btn btn-primary btn-guardia-edit btn-guardia-nuevo" data-toggle="modal" data-target="#formulario_ingreso" id="nuevo_ingreso"><i class="fa fa-plus" aria-hidden="true"></i> Registrar nuevo ingreso</button></a>
	</div>
    @if(isset($_GET['valido']) && $_GET['valido'] == md5('false'))
        <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"></button>
            <strong>Error:</strong> El ingreso no ha sido creado porque el correo otorgado para crear su usuario no está disponible, trate con uno distinto.
        </div>
    @endif
                                        ...
                                        @foreach($ingresos as $ingreso)
                                            <tr class="" id="{{$ingreso->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-success finalizar_visita btn-guardia-clear">Marcar salida</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
